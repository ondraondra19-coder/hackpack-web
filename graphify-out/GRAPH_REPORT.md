...
## Corpus Check
- 170 files · ~131,750 words
- Verdict: corpus is large enough that graph structure adds value.

## Summary
- 1039 nodes · 2506 edges · 68 communities (40 shown, 28 thin omitted)
- Extraction: 99% EXTRACTED · 1% INFERRED · 0% AMBIGUOUS · INFERRED: 23 edges (avg confidence: 0.7)
- Token cost: 0 input · 0 output

## Graph Freshness
- Built from commit: `afa790b9`
...
Cohesion: 0.06
Nodes (57): AccountsAdminPanelProps, PERMISSION_LABELS, AdminDashboard(), AdminDashboardProps, getInitials(), CampaignSummary, Context, AdminPage() (+49 more)
...
Cohesion: 0.10
Nodes (31): Tab, BarChart(), CURRENCY_LABELS, formatDateShort(), formatMoney(), RankedTable(), SectionCard(), StatCard() (+23 more)

### Community 9 - "Reviews System"
Cohesion: 0.32
Nodes (7): calcStats(), formatDate(), RecenzePage(), Review, ReviewCard(), Window, LOCALE_TAGS

### Community 10 - "Cart Page (Kosik)"
Cohesion: 0.06
Nodes (80): InformacePage(), BESTSELLER_SLUGS, getProductImgs(), KosikPage(), ProductCard(), buildDopravyOptions(), buildPlatbyOptions(), MOCK_ZBOXES (+72 more)
...
Cohesion: 0.19
Nodes (8): BlogPreview(), BlogPreviewList(), PreviewPost, calcAvg(), formatDate(), Review, ReviewCard(), Reviews()

### Community 13 - "Category Listing & Featured Products"
Cohesion: 0.09
Nodes (41): POST(), PriceEntry, CheckoutItem, POST(), GET(), fail(), NewsletterErrorCode, POST() (+33 more)
...
Cohesion: 0.08
Nodes (41): DELETE(), POST(), StockEntryInput, fail(), GET(), POST(), ReviewErrorCode, GET() (+33 more)

### Community 19 - "Core NPM Dependencies"
Cohesion: 0.15
Nodes (41): approxConvert(), addressBlock(), bankTransferBlock(), campaignBodyToHtml(), CLAIM_RESOLUTION_LABELS, CLAIM_TYPE_LABELS, claimDetailsTable(), claimLabel() (+33 more)

### Community 22 - "Product Search Bar"
Cohesion: 0.09
Nodes (25): KontaktPage(), ONasPage(), BlogList(), ListPost, CategoryGrid(), ChatWidget(), CheckoutStepper(), Newsletter() (+17 more)
...
Cohesion: 0.16
Nodes (13): buildBenefits(), buildPaymentMethods(), buildShippingMethods(), DopravaClient(), DOBIRKA_FEE, COUNTRIES, PAYMENT_CANONICAL_NAMES, PaymentId (+5 more)
...
- **Why does `useT()` connect `Product Search Bar` to `Orders & Checkout Pipeline`, `Reviews.tsx`, `Terms & Conditions Page`, `browserslist`, `Address Autocomplete Form`, `Reviews System`, `Cart Page (Kosik)`, `Homepage`, `getProductBySlug`, `page.tsx`, `page.tsx`, `package.json`?**
